...
- ✅ cargo-outdated (version freshness, informational `--exit-code 0`) — 12 patch-level updates applied; 4 semver-major tracks deferred (toasty 0.10 ×3, base64 0.23, brotli 8, sha2 0.11) as breaking upgrades needing manual triage.
