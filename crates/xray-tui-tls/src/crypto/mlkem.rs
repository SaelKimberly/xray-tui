//! ML-KEM-768 (Kyber768) primitives via liboqs.
//!
//! This module wraps `oqs::kem::Kyber768` (ML-KEM-768 / FIPS 203) to provide
...
/// ML-KEM-768 (Kyber768) primitive operations.
pub struct Mlkem768;
