...
impl fmt::Display for Protocol {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let s = match self {
            ...
            Self::Shadowsocks2022 => "ss-2022".to_owned(),
            ...
            Self::DokodemoDoor => "dokodemo".to_owned(),
            Self::WireGuard => "wireguard".to_owned(),
...
mod tests {
    ...
    fn display_kebab_case() {
        let cases = [
            ...
            (Protocol::DokodemoDoor, "dokodemo"),
