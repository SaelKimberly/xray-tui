...
impl fmt::Display for Protocol {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let s = match self {
            ...
            Self::ShadowsocksR => "shadowsocks-r".to_owned(),
...
impl FromStr for Protocol {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        match normalized.as_str() {
            ...
            "hysteria_2" | "hysteria2" => Ok(Self::Hysteria2),
            ...
            "shadowsocks_r" | "shadowsocksr" => Ok(Self::ShadowsocksR),
...
mod tests {
    ...
    fn display_kebab_case() {
        let cases = [
            ...
            (Protocol::ShadowsocksR, "shadowsocks-r"),
